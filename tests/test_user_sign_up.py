...
class TestUserSignUp:
    def test_new_user_sign_up_successful(self, driver, email):
    ...
    def test_incorrect_email_error_shown(self, driver, incorrect_email):
    ...
    def test_signup_of_existing_user_error_shown(self, driver, email):
        HelpFunctions.full_sign_up_flow(driver = driver, email = email, password = TestData.password)
